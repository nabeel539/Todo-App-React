...
const style = {
  ...
  heading: `text-3xl font-bold text-gray-800 p-4 text-center min-[320px]:text-2xl`,
  form: `flex justify-between items-center`,
  input: `border p-2 px-5 w-full text-xl  rounded-full text-sm`,
  button: `border p-3 ml-2 bg-purple-600 text-slate-100 rounded-full`,
